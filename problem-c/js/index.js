...
const mostYardsPassing = (game1, game2) => {
...
const makeCombinedFilter = (callback1, callback2) => {
  const combinedFilter = (game) => {
...
const avgScoreDifference =
  huskyGames2016.reduce((sum, game) => {
    const diff = game.home == "UW"
